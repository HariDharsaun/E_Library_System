...
import { BookOpen, Menu, X, User, LogOut, LogIn, BookCopy, Users, Home } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/books" className="hover:text-blue-200 transition duration-300">Books</Link>
            ...
            {user ? (
              <>
                ...
                {isAdmin && (
                  <Link to="/admin" className="hover:text-blue-200 transition duration-300">Admin</Link>
                )}
